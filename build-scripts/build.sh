...
pull_or_clone_proj common-module https://github.com/BrandonRTL/common-module.git
pull_or_clone_proj medical-monitoring https://github.com/BrandonRTL/medical-monitoring.git
pull_or_clone_proj message-analyzer https://github.com/BrandonRTL/message-analyzer.git
pull_or_clone_proj person-service https://github.com/BrandonRTL/person-service.git
